...
import os
import json
from etl.extract_data import extract_data_jobs, extract_data_organization, extract_data_job_categories, extract_data_position_type


@patch('etl.extract_data.fetch_all_pages')
...
@patch('etl.extract_data.fetch_organizations')
...
@patch('etl.extract_data.fetch_job_categories')
...
@patch('etl.extract_data.fetch_position_types')
